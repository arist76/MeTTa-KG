...
impl Screen for IntersectionScreen {
    ...
    fn render(&mut self, f: &mut Frame, area: Rect) {
        ...
        let header = Paragraph::new("Intersection")
        ...
        match key.code {
            ...
            KeyCode::Enter => {
                ...
                if let Some(service) = service {
                    ...
                    tokio::spawn(async move { let _ = service.intersection(&input).await; });
                }
